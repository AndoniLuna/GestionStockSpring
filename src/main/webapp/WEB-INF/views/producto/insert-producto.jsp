...
<html>
<head>
  <title><fmt:message key="producto.crear.title"/></title>
  <style>
    .error { color: red; }
  </style>  
</head>
<body>
	...
	<h1><fmt:message key="producto.crear.title"/></h1>
	
	<li><a href="inventario">Volver al inventario</a></li>
	<br>
	<br>

	<form:form commandName="product" action="insertar-producto.html" method="post">
		...
		<form:input path="description" placeholder="Escribe el nombre del articulo"/>
